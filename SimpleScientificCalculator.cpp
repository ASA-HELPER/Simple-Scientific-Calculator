//Simple Scientific Calculator : This is a simple c++ project created with the help of graphics header file.
//Run this project on turbo c++. It will not work on visual studio code because it does not have graphics.h header file.
...
void graphics()
{
	...
	setbkcolor(RED);
	setcolor(8);
	rectangle(0,0,160,443);
	setfillstyle(SOLID_FILL,WHITE);
	floodfill(2,2,8);
    //Creating choice table for the functions
	outtextxy(10,10,"Choice");
	...
	outtextxy(10,430,"21. EXIT");
    //Creating lines after each choice
	line(0,20,160,20);
	line(0,43,160,43);
	line(0,63,160,63);
	line(0,83,160,83);
    ...
    //Writing the names of functions on the buttons
	setcolor(0);
	outtextxy(248,252, "1");
	outtextxy(300,252, "2");
	outtextxy(348,252, "3");
